...
const Main = ({ heading, image, module_id, showTimelineChart, showPlusIcon, timelineData, reflink }) => {
    console.log("timelinedata in reserach",timelineData);
  ...
  return (
    <>
      ...
      >
        ...
        <Link to={reflink} className="w-1/2 flex flex-col justify-between h-full md:py-5">
