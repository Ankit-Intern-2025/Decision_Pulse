  ...
  return (
    <div>
      <CertainDashboard title="Executive Summary (BFSI Market Overview)">
        <CardedChart chartHeading="Global & Regional BFSI Trends" chartCustomization={lineChartCustomizations} />
        <CardedChart chartHeading="Top Performing Banks & Financial Institutions" chartCustomization={barChartData} />
        <CardedChart chartHeading="Conumer Banking Trends & Insight" chartCustomization={textListData1} />
