  ...
  >
    <div className="w-full h-full flex flex-col gap-4">
      ...
      <div className="flex w-full items-center justify-center h-full">
        <svg viewBox="0 0 200 200" className="w-[70%] h-[80%]">
          <circle cx="100" cy="100" r="100" fill="#f0f0f0" />

          {/* Segmented slices */}
          <path
            d="M100,100 L100,0 A100,100 0 0,1 195,68 Z"
            fill="#e0e0e0"
            className="animate-pulse"
          />
          <path
            d="M100,102 L195,69 A100,100 0 0,1 145,190 Z"
            fill="#d6d6d6"
            className="animate-pulse"
          />
          <path
            d="M99,102 L142,190 A100,110 0 0,1 40,180 Z"
            fill="#e0e0e0"
            className="animate-pulse"
          />
        </svg>
  ...
  >
    <div className="w-full h-full flex flex-col gap-4">
      ...
      <div className="flex justify-center h-full">
        <svg viewBox="0 0 200 200" className="w-[70%] h-[75%]">
          <circle cx="100" cy="100" r="100" fill="#f0f0f0" />
...
const DescriptiveLoading = () => {
  return (
    <div className="flex justify-center w-full">
      <div className="p-1 grid gap-4 grid-cols-1 md:grid-cols-6 justify-items-center items-center w-full">
        {chartSkeletons}
      </div>
    </div>
  );
...
export default DescriptiveLoading;
