...
const DataRefresh = () => {
  ...
  const handleDropdownChange1 = (selectedValue) => {
    setSelectedDropdownValue(selectedValue); // Set selected value
    switch (selectedValue) {
      case "Once a day":
        setFrequency("once_daily");
        break;
      case "Once a weekly":
        setFrequency("once_weekly");
        break;
      case "Once a monthly":
        setFrequency("once_monthly");
        break;
      case "once":
        setFrequency("once");
        break;
                ...
                <div className="flex max-sm:justify-between">
                  <div className="max-sm:w-1/2">
                    ...
                    <div className="max-sm:mr-1">
                      <Dropdown
                        data={dropdownData2}
                        dropdownHandle1={handleDropdownChange1} // Handle value change
                      />
                    </div>
                  </div>

                  {/* Render "Once every" only if selectedDropdownValue is not "once" */}
